                ...
                <div class="input-box">
                    <form method="post" action="<?= base_url('home/aksi_register') ?>">
                     ...
                     <div class="input-field">
                        <input type="text" id="nama" name="nama" class="input text-capitalize" id="email" required="" autocomplete="off">
                    ...
                    <p class="register-link">Apakah sudah punya akun? <a href="/" class="register-button">Login</a></p>
                </form>
            </div>  
        </div>
    </div>
